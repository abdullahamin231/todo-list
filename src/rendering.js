    ...
    for(let i = 0; i < todoList.length; i++){
        ...
        div1.onclick = function () {
            ...
            if(item.done == true){
                ...
                div2.style.opacity = '0.6'; div2.style.transition = 'opacity 250ms ease-in-out';
                div3.style.opacity = '0.6'; div3.style.transition = 'opacity 250ms ease-in-out';
                div4.style.opacity = '0.6'; div4.style.transition = 'opacity 250ms ease-in-out';
                div5.style.opacity = '0.6'; div5.style.transition = 'opacity 250ms ease-in-out';
                div6.style.opacity = '0.6'; div6.style.transition = 'opacity 250ms ease-in-out';
            } else {
                div1.style.background = 'url(../src/images/checkbox-blank-outline.svg)';
                div2.style.textDecoration = 'none';
                div2.style.opacity = '1'; div2.style.transition = 'opacity 250ms ease-in-out';
                div3.style.opacity = '1'; div3.style.transition = 'opacity 250ms ease-in-out';
                div4.style.opacity = '1'; div4.style.transition = 'opacity 250ms ease-in-out';
                div5.style.opacity = '1'; div5.style.transition = 'opacity 250ms ease-in-out';
                div6.style.opacity = '1'; div6.style.transition = 'opacity 250ms ease-in-out';
        ...
        if((filterBy == 'today' && !isDueToday(item)) || (filterBy == 'week' && !isDueWeek(item))){
...
export function renderNotes(){
    ...
    for(let i = 0; i < notesList.length; i++){
        ...
        topDiv.appendChild(title); topDiv.appendChild(details);
        topDiv.id = 'noteDiv';
